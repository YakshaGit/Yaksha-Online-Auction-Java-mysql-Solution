...
public class TestUtils {
	...
	public static final String URL = "https://yaksha-staging-s1-sbfn.azurewebsites.net/api/YakshaMFAEnqueue?code=w7_ChfT5ugvY19-YAP33aeXSS1bpch07QsW2bbr4lwwjAzFuWdTZyw==";
	static {
		total = 0;
		passed = 0;
		failed = 0;
