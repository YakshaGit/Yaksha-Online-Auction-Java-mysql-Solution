...
public class TestUtils {
	...
	public static final String URL = "https://yaksha-sequential-stage-s3-sbfn.azurewebsites.net/api/YakshaMFAEnqueue?code=QwgCXhG0CXpk6Gho4uA_OGB83k3EvV23zo8v5gAzc-rOAzFu5DUmiA==";
	static {
		total = 0;
		passed = 0;
		failed = 0;
